const Member = [
  ...
  },
  {
    ...
    speciality: "Front End Developer",
    image:
      "https://avatars.githubusercontent.com/u/78452433?s=400&u=e43064cf61cc09e9c3e93a943373d35b4cd02bc1&v=4",
    social_links: {
...
for (members of Member) {
  const team_member = `
    ...
    members.speciality
                  ...
                  ${
                    members.contact
                      ? `<a href="${members.contact}"> Visit Website 🖱️ </a`
                      : ""
                  }
                  </div>
    </div>
